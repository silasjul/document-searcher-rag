...
export type Document = {
  ...
  tags: string[];
  isGlobal?: boolean; // If true, document is available in all projects
};
...
export const MOCK_DOCUMENTS: Document[] = [
  ...
  // Global Documents - Available in all projects
  {
    id: "doc-global-1",
    name: "Company_Legal_Guidelines_2024.pdf",
    fileSize: 1843200, // ~1.8 MB
    pageCount: 32,
    uploadedAt: "2024-01-15T08:00:00Z",
    status: "ready",
    tags: ["guidelines", "legal", "company"],
    isGlobal: true,
  },
  {
    id: "doc-global-2",
    name: "Standard_Contract_Terms.pdf",
    fileSize: 921600, // ~900 KB
    pageCount: 18,
    uploadedAt: "2024-01-20T10:30:00Z",
    status: "ready",
    tags: ["contract", "terms", "standard"],
    isGlobal: true,
  },
  {
    id: "doc-global-3",
    name: "Compliance_Framework_2024.pdf",
    fileSize: 2097152, // ~2 MB
    pageCount: 48,
    uploadedAt: "2024-02-01T09:00:00Z",
    status: "ready",
    tags: ["compliance", "framework", "policy"],
    isGlobal: true,
  },
  {
    id: "doc-global-4",
    name: "Data_Privacy_Policy_GDPR.pdf",
    fileSize: 1048576, // ~1 MB
    pageCount: 24,
